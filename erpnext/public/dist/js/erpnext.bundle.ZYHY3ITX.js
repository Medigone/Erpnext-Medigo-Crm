(() => {
  ...
  erpnext.stock.StockController = class StockController extends frappe.ui.form.Controller {
    ...
    setup_warehouse_query() {
      ...
      erpnext.queries.setup_queries(this.frm, "Warehouse", function() {
        return erpnext.queries.warehouse(me2.frm.doc);
      });
    }
    ...
    show_stock_ledger() {
      ...
      if (this.frm.doc.docstatus > 0) {
        cur_frm.add_custom_button(__("Stock Ledger"), function() {
          frappe.route_options = {
            voucher_no: me2.frm.doc.name,
            from_date: me2.frm.doc.posting_date,
            to_date: moment(me2.frm.doc.modified).format("YYYY-MM-DD"),
            company: me2.frm.doc.company,
            show_cancelled_entries: me2.frm.doc.docstatus === 2,
  ...
  erpnext.payments = class payments extends erpnext.stock.StockController {
    ...
    set_payment_primary_action() {
      ...
      this.dialog.set_primary_action(__("Submit"), function() {
        $.each(me2.frm.doc.payments, function(index, data) {
          if (data.amount != 0) {
            me2.dialog.hide();
            me2.submit_invoice();
            return;
    ...
    make_multimode_payment() {
      ...
      if (this.frm.doc.change_amount > 0) {
        me2.payment_val = me2.doc.outstanding_amount;
      }
      ...
      if (this.frm.doc.payments.length) {
        $.each(this.frm.doc.payments, function(index, data) {
          $(frappe.render_template("payment_details", {
            ...
            amount: data.amount,
            idx: data.idx,
            currency: me2.frm.doc.currency,
            type: data.type
          })).appendTo(multimode_payments);
          if (data.type == "Cash" && data.amount == me2.frm.doc.paid_amount) {
            me2.idx = data.idx;
            me2.selected_mode = $(me2.$body).find(repl("input[idx='%(idx)s']", { "idx": me2.idx }));
            me2.highlight_selected_row();
            me2.bind_amount_change_event();
          }
        });
      } else {
    ...
    bind_form_control_event() {
      ...
      $(this.$body).find(".pos-payment-row").click(function() {
        me2.idx = $(this).attr("idx");
        me2.set_outstanding_amount();
      });
      $(this.$body).find(".form-control").click(function() {
        me2.idx = $(this).attr("idx");
        me2.set_outstanding_amount();
        me2.update_paid_amount(true);
      });
      $(this.$body).find(".write_off_amount").change(function() {
        me2.write_off_amount(flt($(this).val()), precision("write_off_amount"));
      });
      $(this.$body).find(".change_amount").change(function() {
        me2.change_amount(flt($(this).val()), precision("change_amount"));
      });
    }
    ...
    bind_numeric_keys_event() {
      ...
      $(this.$body).find(".pos-keyboard-key").click(function() {
        me2.payment_val += $(this).text();
        me2.selected_mode.val(format_currency(me2.payment_val, me2.frm.doc.currency));
        me2.idx = me2.selected_mode.attr("idx");
        me2.update_paid_amount();
      });
      $(this.$body).find(".delete-btn").click(function() {
        me2.payment_val = cstr(flt(me2.selected_mode.val())).slice(0, -1);
        me2.selected_mode.val(format_currency(me2.payment_val, me2.frm.doc.currency));
        me2.idx = me2.selected_mode.attr("idx");
        me2.update_paid_amount();
      });
    ...
    bind_amount_change_event() {
      ...
      this.selected_mode.change(function() {
        me2.payment_val = flt($(this).val()) || 0;
        me2.selected_mode.val(format_currency(me2.payment_val, me2.frm.doc.currency));
        me2.idx = me2.selected_mode.attr("idx");
        me2.update_payment_amount();
      });
    }
    clear_amount() {
      var me2 = this;
    ...
    update_paid_amount(update_write_off) {
      ...
      if (in_list(["change_amount", "write_off_amount"], this.idx)) {
        var value = me2.selected_mode.val();
        if (me2.idx == "change_amount") {
          me2.change_amount(value);
        } else {
          if (flt(value) == 0 && update_write_off && me2.frm.doc.outstanding_amount > 0) {
            value = flt(me2.frm.doc.outstanding_amount / me2.frm.doc.conversion_rate, precision(me2.idx));
          }
          me2.write_off_amount(value);
        }
      } else {
        this.update_payment_amount();
      }
    ...
    update_payment_amount() {
      var me2 = this;
      $.each(this.frm.doc.payments, function(index, data) {
        if (cint(me2.idx) == cint(data.idx)) {
          data.amount = flt(me2.selected_mode.val(), 2);
        }
      });
      this.calculate_outstanding_amount(false);
      this.show_amounts();
  ...
  erpnext.taxes_and_totals = class TaxesAndTotals extends erpnext.payments {
    ...
    calculate_item_values() {
      ...
      if (!this.discount_amount_applied) {
        for (const item of this.frm._items || []) {
          ...
          item.qty = item.qty === void 0 ? me2.frm.doc.is_return ? -1 : 1 : item.qty;
          if (!(me2.frm.doc.is_return || me2.frm.doc.is_debit_note)) {
            item.net_amount = item.amount = flt(item.rate * item.qty, precision("amount", item));
          } else {
            let qty = flt(item.qty);
            if (!qty) {
              qty = me2.frm.doc.is_debit_note ? 1 : -1;
              if (me2.frm.doc.doctype !== "Purchase Receipt" && me2.frm.doc.is_return === 1) {
                qty = flt(item.qty);
              }
            }
          ...
          me2.set_in_company_currency(item, ["price_list_rate", "rate", "amount", "net_rate", "net_amount"]);
        }
      }
    }
    set_in_company_currency(doc, fields) {
      ...
      $.each(fields, function(i, f) {
        doc["base_" + f] = flt(flt(doc[f], precision(f, doc)) * me2.frm.doc.conversion_rate, precision("base_" + f, doc));
      });
    }
    initialize_taxes() {
      var me2 = this;
      $.each(this.frm.doc["taxes"] || [], function(i, tax) {
        ...
        if (cstr(tax.charge_type) != "Actual" && !(me2.discount_amount_applied && me2.frm.doc.apply_discount_on == "Grand Total")) {
    ...
    determine_exclusive_rate() {
      ...
      $.each(me2.frm.doc["taxes"] || [], function(i, row) {
        if (cint(row.included_in_print_rate))
          has_inclusive_tax = true;
      });
      if (has_inclusive_tax == false)
        return;
      $.each(me2.frm._items || [], function(n, item) {
        var item_tax_map = me2._load_item_tax_rate(item.item_tax_rate);
        var cumulated_tax_fraction = 0;
        var total_inclusive_tax_amount_per_qty = 0;
        $.each(me2.frm.doc["taxes"] || [], function(i, tax) {
          var current_tax_fraction = me2.get_current_tax_fraction(tax, item_tax_map);
          tax.tax_fraction_for_current_item = current_tax_fraction[0];
          var inclusive_tax_amount_per_qty = current_tax_fraction[1];
          if (i == 0) {
            tax.grand_total_fraction_for_current_item = 1 + tax.tax_fraction_for_current_item;
          } else {
            tax.grand_total_fraction_for_current_item = me2.frm.doc["taxes"][i - 1].grand_total_fraction_for_current_item + tax.tax_fraction_for_current_item;
          }
          cumulated_tax_fraction += tax.tax_fraction_for_current_item;
          total_inclusive_tax_amount_per_qty += inclusive_tax_amount_per_qty * flt(item.qty);
        });
        if (!me2.discount_amount_applied && item.qty && (total_inclusive_tax_amount_per_qty || cumulated_tax_fraction)) {
          var amount = flt(item.amount) - total_inclusive_tax_amount_per_qty;
          item.net_amount = flt(amount / (1 + cumulated_tax_fraction));
          item.net_rate = item.qty ? flt(item.net_amount / item.qty, precision("net_rate", item)) : 0;
          me2.set_in_company_currency(item, ["net_rate", "net_amount"]);
        }
      });
    }
    ...
    calculate_net_total() {
      ...
      $.each(this.frm._items || [], function(i, item) {
        me2.frm.doc.total += item.amount;
        me2.frm.doc.total_qty += item.qty;
        me2.frm.doc.base_total += item.base_amount;
        me2.frm.doc.net_total += item.net_amount;
        me2.frm.doc.base_net_total += item.base_net_amount;
      });
    }
    ...
    add_taxes_from_item_tax_template(item_tax_map) {
      ...
      if (item_tax_map && cint(frappe.defaults.get_default("add_taxes_from_item_tax_template"))) {
        ...
        $.each(item_tax_map, function(tax, rate) {
          let found = (me2.frm.doc.taxes || []).find((d) => d.account_head === tax);
          if (!found) {
            let child = frappe.model.add_child(me2.frm.doc, "taxes");
    ...
    calculate_taxes() {
      ...
      $.each(this.frm._items || [], function(n, item) {
        var item_tax_map = me2._load_item_tax_rate(item.item_tax_rate);
        $.each(me2.frm.doc["taxes"] || [], function(i, tax) {
          var current_tax_amount = me2.get_current_tax_amount(item, tax, item_tax_map);
          if (frappe.flags.round_row_wise_tax) {
            current_tax_amount = flt(current_tax_amount, precision("tax_amount", tax));
          }
          if (tax.charge_type == "Actual") {
            actual_tax_dict[tax.idx] -= current_tax_amount;
            if (n == me2.frm._items.length - 1) {
              current_tax_amount += actual_tax_dict[tax.idx];
            }
          }
          if (tax.charge_type != "Actual" && !(me2.discount_amount_applied && me2.frm.doc.apply_discount_on == "Grand Total")) {
          ...
          if (i == 0) {
            ...
            tax.grand_total_for_current_item = flt(me2.frm.doc["taxes"][i - 1].grand_total_for_current_item + current_tax_amount);
          }
          if (n == me2.frm._items.length - 1) {
            me2.round_off_totals(tax);
            me2.set_in_company_currency(
              tax,
              ["tax_amount", "tax_amount_after_discount_amount"]
            );
            me2.round_off_base_values(tax);
            me2.set_cumulative_total(i, tax);
            me2.set_in_company_currency(tax, ["total"]);
            if (i == me2.frm.doc["taxes"].length - 1 && me2.discount_amount_applied && me2.frm.doc.apply_discount_on == "Grand Total" && me2.frm.doc.discount_amount) {
              me2.frm.doc.rounding_adjustment = flt(me2.frm.doc.grand_total - flt(me2.frm.doc.discount_amount) - tax.total, precision("rounding_adjustment"));
            }
          }
        });
      });
    ...
    manipulate_grand_total_for_inclusive_tax() {
      ...
      if (this.frm.doc["taxes"] && this.frm.doc["taxes"].length) {
        ...
        if (any_inclusive_tax) {
          var last_tax = me2.frm.doc["taxes"].slice(-1)[0];
          ...
          var diff = me2.frm.doc.total + non_inclusive_tax_amount - flt(last_tax.total, precision("grand_total"));
          if (me2.discount_amount_applied && me2.frm.doc.discount_amount) {
            diff -= flt(me2.frm.doc.discount_amount);
          }
          diff = flt(diff, precision("rounding_adjustment"));
          if (diff && Math.abs(diff) <= 5 / Math.pow(10, precision("tax_amount", last_tax))) {
            me2.frm.doc.rounding_adjustment = diff;
          }
        }
      }
    }
          ...
          $.each(this.frm.doc["taxes"] || [], function(i, tax) {
            if (in_list(["Valuation and Total", "Total"], tax.category)) {
              if (tax.add_deduct_tax == "Add") {
                me2.frm.doc.taxes_and_charges_added += flt(tax.tax_amount_after_discount_amount);
              } else {
                me2.frm.doc.taxes_and_charges_deducted += flt(tax.tax_amount_after_discount_amount);
              }
            }
          });
    ...
    apply_discount_amount() {
      ...
      if (this.frm.doc.discount_amount) {
        ...
        if (total_for_discount_amount) {
          $.each(this.frm._items || [], function(i, item) {
            distributed_amount = flt(me2.frm.doc.discount_amount) * item.net_amount / total_for_discount_amount;
            item.net_amount = flt(
              item.net_amount - distributed_amount,
              precision("base_amount", item)
            );
            net_total += item.net_amount;
            if ((!(me2.frm.doc.taxes || []).length || total_for_discount_amount == me2.frm.doc.net_total || me2.frm.doc.apply_discount_on == "Net Total") && i == (me2.frm._items || []).length - 1) {
              var discount_amount_loss = flt(me2.frm.doc.net_total - net_total - me2.frm.doc.discount_amount, precision("net_total"));
              item.net_amount = flt(
      ...
      if (this.frm.doc.is_pos && (update_paid_amount === void 0 || update_paid_amount)) {
        $.each(this.frm.doc["payments"] || [], function(index, data) {
          if (data.default && payment_status && total_amount_to_pay > 0) {
            ...
            if (me2.frm.doc.party_account_currency == me2.frm.doc.currency) {
              base_amount = flt(total_amount_to_pay * me2.frm.doc.conversion_rate, precision("base_amount", data));
              amount = flt(total_amount_to_pay, precision("amount", data));
            } else {
              base_amount = flt(total_amount_to_pay, precision("base_amount", data));
              amount = flt(total_amount_to_pay / me2.frm.doc.conversion_rate, precision("amount", data));
            }
            frappe.model.set_value(data.doctype, data.name, "base_amount", base_amount);
            frappe.model.set_value(data.doctype, data.name, "amount", amount);
            payment_status = false;
          } else if (me2.frm.doc.paid_amount) {
    ...
    calculate_paid_amount() {
      ...
      if (this.frm.doc.is_pos) {
        $.each(this.frm.doc["payments"] || [], function(index, data) {
          data.base_amount = flt(data.amount * me2.frm.doc.conversion_rate, precision("base_amount", data));
      ...
      if (this.frm.doc.redeem_loyalty_points && this.frm.doc.loyalty_amount) {
        ...
        paid_amount += flt(this.frm.doc.loyalty_amount / me2.frm.doc.conversion_rate, precision("paid_amount"));
      }
  ...
  erpnext.TransactionController = class TransactionController extends erpnext.taxes_and_totals {
    setup() {
      ...
      if (this.frm.fields_dict["return_against"]) {
        this.frm.set_query("return_against", function(doc) {
          ...
          if (me2.frm.fields_dict["customer"] && doc.customer)
            filters["customer"] = doc.customer;
          if (me2.frm.fields_dict["supplier"] && doc.supplier)
    ...
    onload() {
      ...
      if (this.frm.doc.__islocal) {
        ...
        let set_value = (fieldname, value) => {
          if (me2.frm.fields_dict[fieldname] && !me2.frm.doc[fieldname]) {
            return me2.frm.set_value(fieldname, value);
          }
        };
    ...
    setup_quality_inspection() {
      ...
      quality_inspection_field.get_route_options_for_new_doc = function(row) {
        ...
        return {
          ...
          "reference_type": me2.frm.doc.doctype,
          "reference_name": me2.frm.doc.name,
          "item_code": row.doc.item_code,
    ...
    make_payment_request() {
      ...
      frappe.call({
        ...
        args: {
          dt: me2.frm.doc.doctype,
          dn: me2.frm.doc.name,
          recipient_id: me2.frm.doc.contact_email,
          payment_request_type,
          party_type: payment_request_type == "Outward" ? "Supplier" : "Customer",
          party: payment_request_type == "Outward" ? me2.frm.doc.supplier : me2.frm.doc.customer
        },
        callback: function(r) {
          if (!r.exc) {
      ...
      if (taxes_and_charges_field) {
        return frappe.call({
          ...
          args: {
            ...
            "tax_template": me2.frm.doc.taxes_and_charges || "",
            "company": me2.frm.doc.company
          },
          debounce: 2e3,
          callback: function(r) {
              ...
              frappe.run_serially([
                () => {
                  if (r.message.taxes_and_charges) {
                    me2.frm.doc.taxes_and_charges = r.message.taxes_and_charges;
                  }
                  if (r.message.taxes) {
                    me2.frm.set_value("taxes", r.message.taxes);
                  }
                },
                () => me2.set_dynamic_labels(),
                () => me2.calculate_taxes_and_totals()
              ]);
            }
          }
        });
    ...
    item_code(doc, cdt, cdn) {
      ...
      if (["Sales Invoice"].includes(this.frm.doc.doctype)) {
        update_stock = cint(me2.frm.doc.update_stock);
          ...
          return this.frm.call({
            ...
            args: {
              ...
              args: {
                ...
                set_warehouse: me2.frm.doc.set_warehouse,
                warehouse: item.warehouse,
                customer: me2.frm.doc.customer || me2.frm.doc.party_name,
                quotation_to: me2.frm.doc.quotation_to,
                supplier: me2.frm.doc.supplier,
                currency: me2.frm.doc.currency,
                update_stock,
                conversion_rate: me2.frm.doc.conversion_rate,
                price_list: me2.frm.doc.selling_price_list || me2.frm.doc.buying_price_list,
                price_list_currency: me2.frm.doc.price_list_currency,
                plc_conversion_rate: me2.frm.doc.plc_conversion_rate,
                company: me2.frm.doc.company,
                order_type: me2.frm.doc.order_type,
                is_pos: cint(me2.frm.doc.is_pos),
                is_return: cint(me2.frm.doc.is_return),
                is_subcontracted: me2.frm.doc.is_subcontracted,
                ignore_pricing_rule: me2.frm.doc.ignore_pricing_rule,
                doctype: me2.frm.doc.doctype,
                name: me2.frm.doc.name,
                project: item.project || me2.frm.doc.project,
                qty: item.qty || 1,
                net_rate: item.rate,
                ...
                pos_profile: cint(me2.frm.doc.is_pos) ? me2.frm.doc.pos_profile : "",
                cost_center: item.cost_center,
                tax_category: me2.frm.doc.tax_category,
                item_tax_template: item.item_tax_template,
                child_docname: item.name,
                is_old_subcontracting_flow: me2.frm.doc.is_old_subcontracting_flow
              }
            },
            callback: function(r) {
              if (!r.exc) {
                frappe.run_serially([
                  () => {
                    ...
                    me2.add_taxes_from_item_tax_template(d.item_tax_rate);
                    if (d.free_item_data && d.free_item_data.length > 0) {
                      me2.apply_product_discount(d);
                    }
                  },
                  () => {
                    if ((me2.frm.doc.is_internal_customer || me2.frm.doc.is_internal_supplier) && me2.frm.doc.represents_company === me2.frm.doc.company) {
                      me2.get_incoming_rate(
                        item,
                        me2.frm.posting_date,
                        me2.frm.posting_time,
                        me2.frm.doc.doctype,
                        me2.frm.doc.company
                      );
                    } else {
                      me2.frm.script_manager.trigger("price_list_rate", cdt, cdn);
                    }
                  },
                  () => {
                    if (me2.frm.doc.is_internal_customer || me2.frm.doc.is_internal_supplier) {
                      me2.calculate_taxes_and_totals();
                    }
                  },
                  () => me2.toggle_conversion_factor(item),
                  () => {
                  ...
                  () => {
                    if (show_batch_dialog && !frappe.flags.hide_serial_batch_dialog && !frappe.flags.dialog_set) {
                      ...
                      erpnext.show_serial_batch_selector(me2.frm, d, (item2) => {
                        me2.frm.script_manager.trigger("qty", item2.doctype, item2.name);
                        if (!me2.frm.doc.set_warehouse)
                          me2.frm.script_manager.trigger("warehouse", item2.doctype, item2.name);
                        me2.apply_price_list(item2, true);
                      }, void 0, !frappe.flags.hide_serial_batch_dialog);
                    } else {
                      frappe.flags.dialog_set = false;
                    }
                  },
                  () => me2.conversion_factor(doc, cdt, cdn, true),
                  () => me2.remove_pricing_rule(item),
                  () => {
                    if (item.apply_rule_on_other_items) {
                      let key = item.name;
                      me2.apply_rule_on_other_items({ key: item });
                    }
                  },
                  () => {
                    var company_currency = me2.get_company_currency();
                    me2.update_item_grid_labels(company_currency);
                  }
                ]);
              }
            }
    ...
    set_default_internal_warehouse() {
      let me2 = this;
      if (this.frm.doc.doctype === "Sales Invoice" && me2.frm.doc.update_stock || this.frm.doc.doctype == "Delivery Note") {
        if (this.frm.doc.is_internal_customer && this.frm.doc.company === this.frm.doc.represents_company) {
          frappe.db.get_value("Company", this.frm.doc.company, "default_in_transit_warehouse", function(value) {
            me2.frm.set_value("set_target_warehouse", value.default_in_transit_warehouse);
          });
        }
      }
      if (this.frm.doc.doctype === "Purchase Invoice" && me2.frm.doc.update_stock || this.frm.doc.doctype == "Purchase Receipt") {
        if (this.frm.doc.is_internal_supplier && this.frm.doc.company === this.frm.doc.represents_company) {
          frappe.db.get_value("Company", this.frm.doc.company, "default_in_transit_warehouse", function(value) {
            me2.frm.set_value("set_from_warehouse", value.default_in_transit_warehouse);
          });
        }
      }
    }
    company() {
      ...
      var set_pricing = function() {
        if (me2.frm.doc.company && me2.frm.fields_dict.currency) {
          var company_currency = me2.get_company_currency();
          var company_doc = frappe.get_doc(":Company", me2.frm.doc.company);
          if (!me2.frm.doc.currency) {
            me2.frm.set_value("currency", company_currency);
          }
          if (me2.frm.doc.currency == company_currency) {
            me2.frm.set_value("conversion_rate", 1);
          }
          if (me2.frm.doc.price_list_currency == company_currency) {
            me2.frm.set_value("plc_conversion_rate", 1);
          }
          if (company_doc.default_letter_head) {
            if (me2.frm.fields_dict.letter_head) {
              me2.frm.set_value("letter_head", company_doc.default_letter_head);
            }
          }
          let selling_doctypes_for_tc = ["Sales Invoice", "Quotation", "Sales Order", "Delivery Note"];
          if (company_doc.default_selling_terms && frappe.meta.has_field(me2.frm.doc.doctype, "tc_name") && selling_doctypes_for_tc.indexOf(me2.frm.doc.doctype) != -1) {
            me2.frm.set_value("tc_name", company_doc.default_selling_terms);
          }
          ...
          if (company_doc.default_buying_terms && frappe.meta.has_field(me2.frm.doc.doctype, "tc_name") && buying_doctypes_for_tc.indexOf(me2.frm.doc.doctype) != -1) {
            me2.frm.set_value("tc_name", company_doc.default_buying_terms);
          }
          frappe.run_serially([
            () => me2.frm.script_manager.trigger("currency"),
            () => me2.update_item_tax_map(),
            () => me2.apply_default_taxes(),
            () => me2.apply_pricing_rule()
          ]);
        }
      };
      var set_party_account = function(set_pricing2) {
        if (in_list(["Sales Invoice", "Purchase Invoice"], me2.frm.doc.doctype)) {
          if (me2.frm.doc.doctype == "Sales Invoice") {
          ...
          var party = me2.frm.doc[frappe.model.scrub(party_type)];
          if (party && me2.frm.doc.company) {
            return frappe.call({
              ...
              callback: function(r) {
                if (!r.exc && r.message) {
                  me2.frm.set_value(party_account_field, r.message);
                  set_pricing2();
                }
              }
            });
      ...
      if (this.frm.doc.posting_date) {
        ...
        if (this.frm.doc.doctype == "Sales Invoice" && this.frm.doc.customer || this.frm.doc.doctype == "Purchase Invoice" && this.frm.doc.supplier) {
          return frappe.call({
            ...
            args: {
              "posting_date": me2.frm.doc.posting_date,
              "party_type": me2.frm.doc.doctype == "Sales Invoice" ? "Customer" : "Supplier",
              "bill_date": me2.frm.doc.bill_date,
              "party": me2.frm.doc.doctype == "Sales Invoice" ? me2.frm.doc.customer : me2.frm.doc.supplier,
              "company": me2.frm.doc.company
            },
            callback: function(r, rt) {
              if (r.message) {
                me2.frm.doc.due_date = r.message;
                refresh_field("due_date");
                frappe.ui.form.trigger(me2.frm.doc.doctype, "currency");
                me2.recalculate_terms();
              }
            }
          });
        } else {
        ...
        doc.payment_schedule.forEach(
          function(term) {
            if (term.payment_term) {
              me2.payment_term(doc, term.doctype, term.name);
            } else {
              frappe.model.set_value(
                term.doctype,
                term.name,
      ...
      if (this.frm.doc.currency && this.frm.doc.currency !== company_currency && !(this.frm.doc.__onload && this.frm.doc.__onload.ignore_price_list)) {
        this.get_exchange_rate(
          ...
          function(exchange_rate) {
            if (exchange_rate != me2.frm.doc.conversion_rate) {
              me2.set_margin_amount_based_on_currency(exchange_rate);
              me2.set_actual_charges_based_on_currency(exchange_rate);
              me2.frm.set_value("conversion_rate", exchange_rate);
            }
          }
        );
      } else {
    ...
    shipping_rule() {
      ...
      if (this.frm.doc.shipping_rule) {
        return this.frm.call({
          ...
          callback: function(r) {
            me2._calculate_taxes_and_totals();
          }
    ...
    price_list_currency() {
      ...
      if (this.frm.doc.price_list_currency !== company_currency && !(this.frm.doc.__onload && this.frm.doc.__onload.ignore_price_list)) {
        this.get_exchange_rate(
          ...
          company_currency,
          function(exchange_rate) {
            me2.frm.set_value("plc_conversion_rate", exchange_rate);
          }
        );
      } else {
    ...
    uom(doc, cdt, cdn) {
      ...
      me2.calculate_stock_uom_rate(doc, cdt, cdn);
    }
    ...
    calculate_net_weight() {
      ...
      $.each(this.frm.doc["items"] || [], function(i, item) {
        me2.frm.doc.total_net_weight += flt(item.total_weight);
      });
    ...
    change_form_labels(company_currency) {
      ...
      if (frappe.meta.get_docfield(cur_frm.doctype, "base_net_total"))
        cur_frm.toggle_display("base_net_total", show && me2.frm.doc.currency != company_currency);
    }
      ...
      if (this.frm.doc.operations && this.frm.doc.operations.length > 0) {
        ...
        $.each(["base_operating_cost", "base_hour_rate"], function(i, fname) {
          if (frappe.meta.get_docfield(item_grid.doctype, fname))
            item_grid.set_column_disp(fname, me2.frm.doc.currency != company_currency);
        });
      }
      ...
      if (this.frm.doc.payment_schedule && this.frm.doc.payment_schedule.length > 0) {
        ...
        $.each(["base_payment_amount", "base_outstanding", "base_paid_amount"], function(i, fname) {
          if (frappe.meta.get_docfield(schedule_grid.doctype, fname))
            schedule_grid.set_column_disp(fname, me2.frm.doc.currency != company_currency);
        });
      }
    }
    toggle_item_grid_columns(company_currency) {
      ...
      $.each(["base_net_rate", "base_net_amount"], function(i, fname) {
        if (frappe.meta.get_docfield(item_grid.doctype, fname))
          item_grid.set_column_disp(fname, show && me2.frm.doc.currency != company_currency);
      });
    }
    recalculate() {
      this.calculate_taxes_and_totals();
    ...
    ignore_pricing_rule() {
      if (this.frm.doc.ignore_pricing_rule) {
        ...
        $.each(this.frm.doc["items"] || [], function(i, d) {
          if (d.item_code) {
            if (d.is_free_item) {
              me2.frm.get_field("items").grid.grid_rows[i].remove();
            } else {
              item_list.push({
                "doctype": d.doctype,
                "name": d.name,
          ...
          callback: function(r) {
            if (!r.exc && r.message) {
              r.message.forEach((row_item) => {
                me2.remove_pricing_rule(row_item);
              });
              me2._set_values_for_item_list(r.message);
              me2.calculate_taxes_and_totals();
              if (me2.frm.doc.apply_discount_on)
                me2.frm.trigger("apply_discount_on");
            }
          }
        });
      } else {
    ...
    apply_pricing_rule(item, calculate_taxes_and_totals) {
      ...
      return this.frm.call({
        ...
        args: { args, doc: me2.frm.doc },
        callback: function(r) {
          if (!r.exc && r.message) {
            me2._set_values_for_item_list(r.message);
            if (item)
              me2.set_gross_profit(item);
            if (me2.frm.doc.apply_discount_on)
              me2.frm.trigger("apply_discount_on");
          }
        }
    ...
    _get_args(item) {
      ...
      return {
        ...
        "customer": me2.frm.doc.customer || me2.frm.doc.party_name,
        "quotation_to": me2.frm.doc.quotation_to,
        "customer_group": me2.frm.doc.customer_group,
        "territory": me2.frm.doc.territory,
        "supplier": me2.frm.doc.supplier,
        "supplier_group": me2.frm.doc.supplier_group,
        "currency": me2.frm.doc.currency,
        "conversion_rate": me2.frm.doc.conversion_rate,
        "price_list": me2.frm.doc.selling_price_list || me2.frm.doc.buying_price_list,
        "price_list_currency": me2.frm.doc.price_list_currency,
        "plc_conversion_rate": me2.frm.doc.plc_conversion_rate,
        "company": me2.frm.doc.company,
        "transaction_date": me2.frm.doc.transaction_date || me2.frm.doc.posting_date,
        "campaign": me2.frm.doc.campaign,
        "sales_partner": me2.frm.doc.sales_partner,
        "ignore_pricing_rule": me2.frm.doc.ignore_pricing_rule,
        "doctype": me2.frm.doc.doctype,
        "name": me2.frm.doc.name,
        "is_return": cint(me2.frm.doc.is_return),
        "update_stock": in_list(["Sales Invoice", "Purchase Invoice"], me2.frm.doc.doctype) ? cint(me2.frm.doc.update_stock) : 0,
        "conversion_factor": me2.frm.doc.conversion_factor,
        "pos_profile": me2.frm.doc.doctype == "Sales Invoice" ? me2.frm.doc.pos_profile : "",
        "coupon_code": me2.frm.doc.coupon_code
      };
    }
    _get_item_list(item) {
      var item_list = [];
    ...
    apply_price_list(item, reset_plc_conversion) {
      ...
      if (me2.in_apply_price_list == true)
        return;
      me2.in_apply_price_list = true;
      return this.frm.call({
        ...
        callback: function(r) {
          if (!r.exc) {
            frappe.run_serially([
              () => me2.frm.set_value("price_list_currency", r.message.parent.price_list_currency),
              () => me2.frm.set_value("plc_conversion_rate", r.message.parent.plc_conversion_rate),
              () => {
                if (args.items.length) {
                  me2._set_values_for_item_list(r.message.children);
                  $.each(r.message.children || [], function(i, d) {
                    me2.apply_discount_on_item(d, d.doctype, d.name, "discount_percentage");
                  });
                }
              },
              () => {
                me2.in_apply_price_list = false;
              }
            ]);
          } else {
            me2.in_apply_price_list = false;
    ...
    validate_company_and_party() {
      ...
      $.each(["company", "customer"], function(i, fieldname) {
        if (frappe.meta.has_field(me2.frm.doc.doctype, fieldname) && !["Purchase Order", "Purchase Invoice"].includes(me2.frm.doc.doctype)) {
          if (!me2.frm.doc[fieldname]) {
            frappe.msgprint(__("Please specify") + ": " + frappe.meta.get_label(me2.frm.doc.doctype, fieldname, me2.frm.doc.name) + ". " + __("It is needed to fetch Item Details."));
            valid = false;
          }
        }
      });
    ...
    get_terms() {
      ...
      erpnext.utils.get_terms(this.frm.doc.tc_name, this.frm.doc, function(r) {
        if (!r.exc) {
          me2.frm.set_value("terms", r.message);
        }
      });
    }
    taxes_and_charges() {
      ...
      if (this.frm.doc.taxes_and_charges) {
        return this.frm.call({
          ...
          callback: function(r) {
            if (!r.exc) {
              if (me2.frm.doc.shipping_rule && me2.frm.doc.taxes) {
                for (let tax of r.message) {
                  me2.frm.add_child("taxes", tax);
                }
                refresh_field("taxes");
              } else {
                me2.frm.set_value("taxes", r.message);
                me2.calculate_taxes_and_totals();
              }
            }
          }
    ...
    tax_category() {
      var me2 = this;
      if (me2.frm.updating_party_details)
        return;
      frappe.run_serially([
    ...
    update_item_tax_map() {
      ...
      if (item_codes.length) {
        return this.frm.call({
          ...
          args: {
            company: me2.frm.doc.company,
            tax_category: cstr(me2.frm.doc.tax_category),
            item_codes,
            item_rates,
            item_tax_templates
          },
          callback: function(r) {
            if (!r.exc) {
              $.each(me2.frm.doc.items || [], function(i, item) {
                if (item.name && r.message.hasOwnProperty(item.name) && r.message[item.name].item_tax_template) {
                  item.item_tax_template = r.message[item.name].item_tax_template;
                  item.item_tax_rate = r.message[item.name].item_tax_rate;
                  me2.add_taxes_from_item_tax_template(item.item_tax_rate);
                }
              });
            }
          }
    ...
    make_mapped_payment_entry(args) {
      ...
      return frappe.call({
        method: me2.get_method_for_payment(),
        args,
        callback: function(r) {
          var doclist = frappe.model.sync(r.message);
          frappe.set_route("Form", doclist[0].doctype, doclist[0].name);
    ...
    prompt_user_for_reference_date() {
      ...
      frappe.prompt(
        ...
        (values) => {
          ...
          me2.make_mapped_payment_entry(args);
        },
    ...
    set_query_for_batch(doc, cdt, cdn) {
      ...
      if (!item.item_code) {
        ...
        let filters = {
          "item_code": item.item_code,
          "posting_date": me2.frm.doc.posting_date || frappe.datetime.nowdate()
        };
        if (doc.is_return) {
          filters["is_return"] = 1;
        }
    ...
    payment_terms_template() {
      ...
      if (doc.payment_terms_template && doc.doctype !== "Delivery Note") {
        ...
        frappe.call({
          ...
          callback: function(r) {
            if (r.message && !r.exc) {
              me2.frm.set_value("payment_schedule", r.message);
              const company_currency = me2.get_company_currency();
              me2.update_payment_schedule_grid_labels(company_currency);
            }
          }
        });
      }
  ...
  // frappe-html:/home/wezri/frappe-bench/apps/erpnext/erpnext/public/js/templates/item_selector.html
...
`;
  ...
  erpnext.ItemSelector = class ItemSelector {
    ...
    make_dialog() {
      ...
      this.dialog.results.on("click", ".image-view-item", function() {
        me2.add_item($(this).attr("data-name"));
      });
      this.dialog.input.on("keyup", function() {
        if (me2.timeout_id) {
          clearTimeout(me2.timeout_id);
        }
        me2.timeout_id = setTimeout(function() {
          me2.render_items();
          me2.timeout_id = void 0;
        }, 500);
      });
    }
    add_item(item_code) {
    ...
    render_items() {
      ...
      frappe.link_search("Item", args, function(results) {
        ...
        me2.dialog.results.html(frappe.render_template("item_selector", { "data": results }));
      });
    }
  };
  ...
  // frappe-html:/home/wezri/frappe-bench/apps/erpnext/erpnext/public/js/templates/item_quick_entry.html
...
`;
  ...
  erpnext.accounts.dimensions = {
    ...
    fetch_custom_dimensions(frm, doctype) {
      ...
      frappe.call({
        ...
        callback: function(r) {
          me2.accounting_dimensions = r.message[0];
          me2.default_dimensions = r.message[1];
          me2.setup_filters(frm, doctype);
        }
      });
    },
  ...
  erpnext.accounts.ledger_preview = {
        ...
        frm.add_custom_button(__("Accounting Ledger"), function() {
          frappe.call({
            ...
            "callback": function(response) {
              me2.make_dialog("Accounting Ledger Preview", "accounting_ledger_preview_html", response.message.gl_columns, response.message.gl_data);
            }
          });
        }, __("Preview"));
      }
      ...
      if (!frm.is_new() && frm.doc.docstatus == 0) {
        frm.add_custom_button(__("Stock Ledger"), function() {
          frappe.call({
            ...
            "callback": function(response) {
              me2.make_dialog("Stock Ledger Preview", "stock_ledger_preview_html", response.message.sl_columns, response.message.sl_data);
            }
          });
        }, __("Preview"));
      }
    ...
    make_dialog(label, fieldname, columns, data) {
      ...
      setTimeout(function() {
        me2.get_datatable(columns, data, dialog.get_field(fieldname).wrapper);
      }, 200);
      dialog.show();
    },
  ...
  erpnext.utils.BarcodeScanner = class BarcodeScanner {
    ...
    process_scan() {
      return new Promise((resolve, reject) => {
        ...
        this.scan_api_call(input, (r) => {
          ...
          me2.update_table(data).then((row) => {
    ...
    prepare_item_for_scan(row, item_code, barcode, batch_no, serial_no) {
      ...
      this.dialog = new frappe.ui.Dialog({
        ...
        fields: me2.get_fields_for_dialog(row, item_code, barcode, batch_no, serial_no)
      });
  ...
  // frappe-html:/home/wezri/frappe-bench/apps/erpnext/erpnext/public/js/templates/call_link.html
...
`;
      ...
      frappe.call({
        ...
        callback: (r) => {
          if (!r.exc) {
            ...
            $(activities_html).appendTo(me2.open_activities_wrapper);
            $(".open-tasks").find(".completion-checkbox").on("click", function() {
              me2.update_status(this, "ToDo");
            });
            $(".open-events").find(".completion-checkbox").on("click", function() {
              me2.update_status(this, "Event");
            });
            me2.create_task();
            me2.create_event();
          }
  ...
  // frappe-html:/home/wezri/frappe-bench/apps/erpnext/erpnext/public/js/templates/crm_activities.html
...
.form-footer {
  ...
  // frappe-html:/home/wezri/frappe-bench/apps/erpnext/erpnext/public/js/templates/crm_notes.html
    ...
    setup_tax_validations: function(doctype) {
      ...
      frappe.ui.form.on(doctype, {
        setup: function(frm) {
          $(frm.wrapper).on("grid-row-render", function(e, grid_row) {
            if (in_list(["Sales Taxes and Charges", "Purchase Taxes and Charges"], grid_row.doc.doctype)) {
              me2.set_conditional_mandatory_rate_or_amount(grid_row);
            }
          });
        },
        onload: function(frm) {
        ...
        taxes_on_form_rendered: function(frm) {
          me2.set_conditional_mandatory_rate_or_amount(frm.open_grid_row());
        }
      });
    },
    ...
    setup_tax_filters: function(doctype) {
      ...
      frappe.ui.form.on(doctype, {
        ...
        row_id: function(frm, cdt, cdn) {
          me2.validate_taxes_and_charges(cdt, cdn);
        },
        ...
        charge_type: function(frm, cdt, cdn) {
          ...
          if (open_form) {
            me2.set_conditional_mandatory_rate_or_amount(open_form);
          } else {
            me2.set_conditional_mandatory_rate_or_amount(frm.get_field("taxes").grid.get_row(cdn));
          }
        },
        included_in_print_rate: function(frm, cdt, cdn) {
          ...
          try {
            me2.validate_taxes_and_charges(cdt, cdn);
            me2.validate_inclusive_tax(tax);
          } catch (e) {
      ...
      erpnext.selling.SellingController = class SellingController extends erpnext.TransactionController {
        ...
        setup_queries() {
          ...
          $.each(
            ...
            function(i, opts) {
              if (me2.frm.fields_dict[opts[0]])
                me2.frm.set_query(opts[0], erpnext.queries[opts[1]]);
            }
          );
          me2.frm.set_query("contact_person", erpnext.queries.contact_query);
          me2.frm.set_query("customer_address", erpnext.queries.address_query);
          me2.frm.set_query("shipping_address_name", erpnext.queries.address_query);
          me2.frm.set_query("dispatch_address_name", erpnext.queries.dispatch_address_query);
          erpnext.accounts.dimensions.setup_dimension_filters(me2.frm, me2.frm.doctype);
          ...
          if (this.frm.fields_dict["items"].grid.get_field("item_code")) {
            this.frm.set_query("item_code", "items", function() {
              return {
                query: "erpnext.controllers.queries.item_query",
                filters: { "is_sales_item": 1, "customer": me2.frm.doc.customer, "has_variants": 0 }
              };
            });
          }
          if (this.frm.fields_dict["packed_items"] && this.frm.fields_dict["packed_items"].grid.get_field("batch_no")) {
            this.frm.set_query("batch_no", "packed_items", function(doc, cdt, cdn) {
              return me2.set_query_for_batch(doc, cdt, cdn);
            });
          }
          if (this.frm.fields_dict["items"].grid.get_field("item_code")) {
            this.frm.set_query("item_tax_template", "items", function(doc, cdt, cdn) {
              return me2.set_query_for_item_tax_template(doc, cdt, cdn);
            });
          }
        }
        refresh() {
        ...
        calculate_contribution() {
          ...
          $.each(this.frm.doc.doctype.sales_team || [], function(i, sales_person) {
            ...
            if (!sales_person.allocated_percentage)
              return;
            sales_person.allocated_amount = flt(
              me2.frm.doc.amount_eligible_for_commission * sales_person.allocated_percentage / 100,
              precision("allocated_amount", sales_person)
            );
          });
        }
        ...
        company_address() {
          ...
          if (this.frm.doc.company_address) {
            frappe.call({
              ...
              callback: function(r) {
                if (r.message) {
                  me2.frm.set_value("company_address_display", r.message);
                }
              }
            });
          } else {
          ...
          if (in_list(["Delivery Note", "Sales Invoice", "Sales Order"], this.frm.doc.doctype)) {
            if (this.frm.doc.project) {
              frappe.call({
                ...
                callback: function(r, rt) {
                  if (!r.exc) {
                    $.each(me2.frm.doc["items"] || [], function(i, row) {
                      if (r.message) {
    ...
    setup_buying_controller: function() {
      erpnext.buying.BuyingController = class BuyingController extends erpnext.TransactionController {
        ...
        setup_queries(doc, cdt, cdn) {
          ...
          me2.frm.set_query("supplier", erpnext.queries.supplier);
          me2.frm.set_query("contact_person", erpnext.queries.contact_query);
          me2.frm.set_query("supplier_address", erpnext.queries.address_query);
          me2.frm.set_query("billing_address", erpnext.queries.company_address_query);
          erpnext.accounts.dimensions.setup_dimension_filters(me2.frm, me2.frm.doctype);
          ...
          this.frm.set_query("item_code", "items", function() {
            if (me2.frm.doc.is_subcontracted) {
              var filters = { "supplier": me2.frm.doc.supplier };
              if (me2.frm.doc.is_old_subcontracting_flow) {
                filters["is_sub_contracted_item"] = 1;
              } else {
                filters["is_stock_item"] = 0;
              }
              ...
              return {
                query: "erpnext.controllers.queries.item_query",
                filters: { "supplier": me2.frm.doc.supplier, "is_purchase_item": 1, "has_variants": 0 }
              };
            }
          });
          ...
          if (this.frm.fields_dict["items"].grid.get_field("item_code")) {
            this.frm.set_query("item_tax_template", "items", function(doc2, cdt2, cdn2) {
              return me2.set_query_for_item_tax_template(doc2, cdt2, cdn2);
            });
          }
        }
        refresh(doc) {
        ...
        set_from_product_bundle() {
          ...
          this.frm.add_custom_button(__("Product Bundle"), function() {
            erpnext.buying.get_items_from_product_bundle(me2.frm);
          }, __("Get Items From"));
        }
        shipping_address() {
          var me2 = this;
                ...
                new erpnext.SerialBatchPackageSelector(
                  ...
                  (r2) => {
                    if (r2) {
                      let update_values = {
                        "serial_and_batch_bundle": r2.name,
                        "rejected_qty": Math.abs(r2.total_qty)
                      };
                      if (r2.warehouse) {
...
//# sourceMappingURL=erpnext.bundle.ZYHY3ITX.js.map
